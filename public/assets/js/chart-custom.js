...
-----------------------------------------------------------------------*/
  ...
  ---------------------------------------------------------------------*/
    if (jQuery("#layout1-chart1").length) {
        ...
        var incomeWeekly = JSON.parse(
            chartDiv.getAttribute("data-income-weekly")
        );
        var incomeTotal = JSON.parse(
            chartDiv.getAttribute("data-income-total")
        );
        ...
        var options = {
            ...
            series: [
                {
                    data: lineData, // Use the converted line data
                },
            ],
            markers: {
                size: 6, // Size of the markers
                shape: "circle", // Shape of the markers, set to 'circle' for round shapes
                colors: ["#598DFA"], // Marker color
    ...
    if (jQuery("#layout1-chart-3").length) {
        ...
        const chart = new ApexCharts(
            document.querySelector("#layout1-chart-3"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout1-chart-4").length) {
        ...
        const chart = new ApexCharts(
            document.querySelector("#layout1-chart-4"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
  ...
  ---------------------------------------------------------------------*/
    if (jQuery("#report-chart1").length) {
        ...
        (chart = new ApexCharts(
            document.querySelector("#report-chart1"),
            options
        )).render();
        const body = document.querySelector("body");
        if (body.classList.contains("dark")) {
    ...
    if (jQuery("#report-chart02").length) {
        ...
        (chart = new ApexCharts(
            document.querySelector("#report-chart02"),
            options
        )).render();
        const body = document.querySelector("body");
        if (body.classList.contains("dark")) {
    ...
    if (jQuery("#report-chart3").length) {
        ...
        (chart = new ApexCharts(
            document.querySelector("#report-chart3"),
            options
        )).render();
        const body = document.querySelector("body");
        if (body.classList.contains("dark")) {
    ...
    if (jQuery("#report-chart4").length) {
        ...
        (chart = new ApexCharts(
            document.querySelector("#report-chart4"),
            options
        )).render();
        const body = document.querySelector("body");
        if (body.classList.contains("dark")) {
