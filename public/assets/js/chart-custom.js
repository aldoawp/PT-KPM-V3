...
if (jQuery("#editor").length) {
  ...
  if (jQuery("#layout1-chart1").length) {
    ...
    var options = {
        ...
        title: {
            text: new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(incomeTotal.total),
            align: "left"
        },
        xaxis: {
            type: "datetime"
    ...
    // Render the chart
    var chart = new ApexCharts(document.querySelector("#layout1-chart1"), options);
    chart.render();
