            ...
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">Dasbor gaji di muka memungkinkan Anda dengan mudah mengumpulkan dan <br>
                            memvisualisasikan data gaji lanjutan dari mengoptimalkan Pengalaman gaji di muka, <br>
                            memastikan retensi gaji sebelumnya. </p>
                    </div>
                    <div>
                        <a href="{{ route('advance-salary.create') }}" class="btn btn-primary add-list"><i
                                class="fas fa-plus mr-3"></i></i>Tambah Pinjaman</a>
                        ...
                        <tbody class="ligth-body">
                            @forelse ($advance_salaries as $advance_salary)
                                <tr>
                                    ...
                                    <td>{{ $advance_salary->advance_salary ? 'Rp ' . number_format($advance_salary->advance_salary, 0, ',', '.') : 'No Advance' }}
                                    </td>
                                    <td>w</td>
                                    <td>w</td>
                                    <td>
                                        <form action="{{ route('advance-salary.destroy', $advance_salary->id) }}"
                                            ...
                                            <div class="d-flex align-items-center list-action">
                                                <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    href="{{ route('advance-salary.edit', $advance_salary->id) }}"><i
