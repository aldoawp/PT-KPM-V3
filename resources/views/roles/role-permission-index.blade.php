    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Daftar Hak Akses Berdasarkan Peran</h4>
                </div>
                <div>
                    <a href="{{ route('rolePermission.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus mr-3"></i>Tambah Hak Akses Peranan</a>
                </div>
            </div>
        </div>
