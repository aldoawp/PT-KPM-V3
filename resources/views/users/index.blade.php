                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    ...
                    <div>
                        <a href="{{ route('users.create') }}" class="btn btn-primary add-list"><i
                                class="fa-solid fa-plus mr-3"></i>Tambah Pengguna</a>
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody class="ligth-body">
                            ...
                            @forelse ($users as $item)
                                @if ((auth()->user()->isSuperAdmin() && $item->role->name === 'SuperAdmin') || $item->role->name !== 'SuperAdmin')
                                    <tr>
                                        <td>{{ $users->currentPage() * 10 - 10 + $iter++ }}</td>
                                        <td>
