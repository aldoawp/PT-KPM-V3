            ...
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">Dasbor kehadiran memungkinkan Anda dengan mudah mengumpulkan dan memvisualisasikan
                            data <br> kehadiran dari mengoptimalkan pengalaman kehadiran, memastikan retensi kehadiran.</p>
                    </div>
                    <div>
                        <a href="{{ route('attendence.create') }}" class="btn btn-primary add-list"><i
                                class="fas fa-plus mr-3"></i>Tambah Absensi</a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center list-action">
                                            <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top"
                                                ...
                                                href="{{ route('attendence.edit', ['date' => $attendence->date, 'branch_id' => $attendence->branch_id]) }}"><i
