        ...
        <div class="card-body">
            <div class="d-flex align-items-center mb-3">
                <div class="profile-img position-relative">
                    <img src="{{ $user->photo ? asset('storage/profile/' . $user->photo) : asset('assets/images/user/1.png') }}"
                        class="img-fluid rounded avatar-110" alt="profile-image">
                </div>
                <div class="ml-3">
                    <h4 class="mb-1">{{ $user->name }}</h4>
                    <p class="mb-2">{{ isset($user->role_id) ? $user->role->name : '-' }}</p>
            ...
            <ul class="list-inline p-0 m-0">
                ...
                <li class="mb-2">
                    <div class="d-flex align-items-center">
                        ...
                        <p class="mb-0">
                            {{ isset($user->branch_id) ? $user->branch->region : 'Unknown' }}
                        </p>
                    </div>
                </li>
            </ul>
